...
define('mode', default='standalone', help='Run mode: standalone, master, slave')
define('master_url', default='', help='Master URL for slave mode')
define('secret', default='', help='Secret token for cluster authentication')
define('auth_password', default='', help='Password for master dashboard authentication')
define('external_url', default='', help='External URL of this node (for connection from Master)')
define('ssh_host', default='localhost', help='Target SSH hostname')
